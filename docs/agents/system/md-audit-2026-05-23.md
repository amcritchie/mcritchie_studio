...
### Wave 2 — Agent-onboarding readiness (the patterns + model docs)
...
### Wave 3 — Today's agent-stack expansion ripple
...
### Wave 4 — Status truth (resolve aspirational vs shipped)
