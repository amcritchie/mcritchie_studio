...
puts "  Contracts: #{Contract.count} (college: #{Contract.where(contract_type: 'college').count}, active: #{Contract.where(contract_type: 'active').count}, draft: #{Contract.where(contract_type: 'draft_pick').count})"
