news_data = [
  {
    ...
    feeling: "bittersweet", feeling_emoji: "\u{1F979}", what_happened: "Retirement announcement",
  ...
  },
  {
    ...
    feeling: "hyped", feeling_emoji: "\u{1F525}", what_happened: "Hat trick in qualifier"
  },
  {
  ...
  },
  {
    ...
    feeling: "excited", feeling_emoji: "\u{1F480}", what_happened: "Group of death identified",
  ...
  # --- 2025 NFL Draft — Concluded Mock Draft Picks ---
  {
    title: "Titans select Cameron Ward with the #1 overall pick in the 2025 NFL Draft",
    stage: "concluded",
    author: "McRitchie Studio",
    published_at: "2025-04-25T00:10:00Z",
    primary_person: "Cameron Ward", primary_team: "Tennessee Titans", primary_action: "Draft Pick #1",
    primary_person_slug: "cameron-ward", primary_team_slug: "tennessee-titans",
    title_short: "Ward Goes #1",
    summary: "Cameron Ward is the first overall pick in the 2025 NFL Draft, selected by the Tennessee Titans. The Miami QB becomes HC Brian Callahan's franchise cornerstone.",
    feeling: "hyped", feeling_emoji: "\u{1F525}", what_happened: "First overall pick",
    opinion: "Ward is the real deal. Callahan now has his guy to build around in Nashville. The Titans offense just got a massive upgrade.",
    callback: "Track Ward's rookie season — compare to recent #1 QB picks (Bryce Young, Caleb Williams)."
  },
  {
    title: "Jaguars trade up to #2 and select two-way star Travis Hunter",
    stage: "concluded",
    author: "McRitchie Studio",
    published_at: "2025-04-25T00:15:00Z",
    primary_person: "Travis Hunter", primary_team: "Jacksonville Jaguars", primary_action: "Draft Pick #2",
    secondary_team: "Cleveland Browns",
    primary_person_slug: "travis-hunter", primary_team_slug: "jacksonville-jaguars",
    secondary_team_slug: "cleveland-browns",
    title_short: "Hunter to Jags",
    summary: "The Jaguars trade up from #5 to #2 with Cleveland, giving up multiple picks to land Travis Hunter. Jacksonville plans to play him on both sides of the ball.",
    feeling: "mind-blown", feeling_emoji: "\u{1F92F}", what_happened: "Trade up for two-way player",
    opinion: "Generational talent on both sides of the ball. The Jags are going all-in and it could reshape how NFL teams think about versatile players.",
    callback: "Monitor Hunter's snap counts on offense vs defense through the preseason."
  },
  {
    title: "Giants select pass rusher Abdul Carter at #3 overall",
    stage: "concluded",
    author: "McRitchie Studio",
    published_at: "2025-04-25T00:20:00Z",
    primary_person: "Abdul Carter", primary_team: "New York Giants", primary_action: "Draft Pick #3",
    primary_person_slug: "abdul-carter", primary_team_slug: "new-york-giants",
    title_short: "Carter to Giants",
    summary: "The New York Giants take Penn State edge rusher Abdul Carter with the third overall pick. GM Joe Schoen also confirmed they are picking up Kayvon Thibodeaux's fifth-year option.",
    feeling: "solid", feeling_emoji: "\u{1F4AA}", what_happened: "Pass rusher selection",
    opinion: "Carter + Thibodeaux gives the Giants a scary edge rush duo. Smart pick to address the trenches instead of reaching for a QB.",
    callback: "Compare Carter's rookie sack totals to recent top-5 edge picks."
  },
  # --- 2025 NFL Draft Round 1 — @AdamSchefter (oldest -> newest) ---
  *[
    { title: "Cam Ward now becomes the fourth No. 1 overall pick that Titans HC Brian Callahan has worked with in his career:\n\n\u{1F3C8}Peyton Manning \n\u{1F3C8}Matthew Stafford\n\u{1F3C8}Joe Burrow\n\u{1F3C8}Cam Ward", x_post_id: "1915559988291940537", published_at: "2025-04-25T00:14:25Z" },
    { title: "ESPN Sources:\n\n\u{1F3C8}Browns are trading the No. 2 overall pick, a fourth-round pick (No. 104), and a sixth-round pick (No. 200) to the Jaguars.\n\n\u{1F3C8}Jaguars are trading the No. 5 overall pick, a second-round pick (No. 36), a fourth-round pick (No. 126) and their 2026 first-round pick", x_post_id: "1915560003773043116", published_at: "2025-04-25T00:14:28Z" },
    ...
    { title: "The projected Patriots offensive line in front of Drake Maye:\n\n\u{1F3C8}LT: Will Campbell \n\u{1F3C8}LG: Cole Strange \n\u{1F3C8}C: Garrett Bradbury \n\u{1F3C8}RG: Mike Onwenu \n\u{1F3C8}RT: Morgan Moses", x_post_id: "1915566391022715263", published_at: "2025-04-25T00:39:51Z" },
    ...
    { title: "Bucs offense now includes:\n\n\u{1F3C8}QB Baker Mayfield\n\u{1F3C8}RB Bucky Irving\n\u{1F3C8}WR Mike Evans\n\u{1F3C8}WR Chris Godwin\n\u{1F3C8}WR Emeka Egbuka\n\u{1F3C8}WR Jalen McMillan\n\u{1F3C8}TE Cade Otton", x_post_id: "1915589813668823061", published_at: "2025-04-25T02:12:56Z" },
    ...
    { title: "Falcons get:\n\u{1F3C8}2025 1st-round pick (No. 26)\n\u{1F3C8}2025 3rd-round pick\n\nRams get:\n\u{1F3C8}2025 2nd-round pick (No. 46)\n\u{1F3C8}2026 1st-round pick\n\u{1F3C8}2025 7th-round pick", x_post_id: "1915601758123970664", published_at: "2025-04-25T03:00:23Z" },
    ...
    { title: "Trade:\n\n\u{1F3C8}Eagles trade No. 32 and No. 164 to the Chiefs\n\n\u{1F3C8}Chiefs trade No. 31 to Eagles.\n\nEagles on the clock.", x_post_id: "1915609101972779048", published_at: "2025-04-25T03:29:34Z" },
